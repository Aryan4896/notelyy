...
const express = require("express");
const cookieParser = require("cookie-parser");
const userModel = require("./models/user"); // Assuming userModel is in ./models/user.js
const postModel = require("./models/post"); // Assuming postModel is in ./models/post.js
const bcrypt = require("bcrypt");
const jwt = require("jsonwebtoken");
const mongoose = require("mongoose");
...
mongoose
  .connect(process.env.MONGODB_URI, {
    ...
    useFindAndModify: false, // Ensure this option is set to false for findOneAndUpdate to work properly
  })
  .then(() => {
    console.log("Connected to MongoDB");
  })
